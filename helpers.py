...
def plot_images(images:list,grid:tuple, size:tuple, image_titles:'`None`, `1` or a `list()`' = None,cmap_type:list = None, axis = 0, hspace = .2, wspace = .001,save_plot = 0,filepath = None):
    """
